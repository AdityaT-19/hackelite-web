...
export const Vortex = (props) => {
  ...
  return (
    <div className={cn("relative items-center", props.containerClassName)}>
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        ref={containerRef}
        className="absolute h-full w-[95vw] inset-0 z-0 bg-transparent flex items-center justify-center"
      >
