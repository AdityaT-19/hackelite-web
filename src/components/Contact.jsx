      ...
      <div className='flex sm:w-6/12 w-5/12 gap-10 items-center  justify-center sm:justify-around'>  
                ...
                <div className='min-h-full font-bold text-lg md:flex hidden justify-center gap-5    flex-col'>
                    <div>
                        ...
                        <span  className='text-white'>Phone</span> <a href='tel:9508372431' className='text-white'>+91 9508372431</a>
                    </div>
                    <p className=' text-[#9D50FF]'>Email <a className='text-white' href='mailto:hackelitecse2024@jssstuniv.in' >hackelitecse2024@jssstuniv.in</a></p>
                </div>
      </div>
    </div>
  )
