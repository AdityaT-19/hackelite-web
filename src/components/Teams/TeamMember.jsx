...
const TeamMember = ({ name, role, image, description, linkedinId }) => {
  return (
    <motion.div
      ...
      transition={{ duration: 0.4 }} // Redirect to LinkedIn profile
    >
      {/* Card Background */}
      <div className="absolute bottom-0 left-0 right-0 h-[180px]">
        <div
          ...
          style={{
            clipPath:
              "polygon(0% 15%, 40% 0%, 100% 0%, 100% 85%, 60% 100%, 0% 100%)",
          }}
        />
        <div
      ...
      {/* Image */}
      <div
        className="absolute top-0 left-1/2 transform -translate-x-1/2 w-[100px] h-[100px] overflow-hidden"
      ...
      {/* Name and Role */}
      <div className="absolute bottom-10 left-4 right-4 p-2 text-center transition-all duration-300 ease-in-out group-hover:opacity-0 group-hover:translate-y-[-10px]">
        <h3
      ...
      <div className="absolute bottom-10 left-3 right-3 hidden group-hover:flex flex-col items-center justify-center text-center transition-all duration-300 ease-in-out">
        <p
