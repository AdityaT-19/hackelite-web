...
function Hero() {
  return (
    ...
    >
      <div className="flex items-center gap-16 lg:gap-24 flex-col">
        <div className="flex items-center justify-center flex-col">
          ...
          <div className="flex justify-between sm:w-[50vw] max-lg:flex-col items-center p-2 gap-2">
            <h2 className="text-white text-sm sm:text-xl font-subhackalite">
              Fuel Your Code Ignite the Future
            </h2>
      ...
      <div className="relative xl:absolute w-72 sm:w-96 h-20 sm:h-24 sm:right-8 sm:bottom-4 text-white flex sm:px-10 justify-evenly items-center countdown">
        <svg
